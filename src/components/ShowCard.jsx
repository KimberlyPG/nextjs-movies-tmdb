      ...
      <div className='relative'>
        ...
        {item.release_date && page !== 'home' &&
          <span className='flex z-10 absolute bottom-0 p-1 text-white space-x-5 text-xs font-bold'>
            ...
            {item.adult === true ? (
              <p className='bg-gray-600 bg-opacity-60 rounded-lg px-2 py-1 border border-green-400'>18+</p> 
              ):(
              <p className='bg-gray-600 bg-opacity-60 rounded-lg px-2 py-1 border border-green-400'>ALL</p>
            )}
          </span>
        }   
